...
vim.keymap.set('n', '<leader>?', vim.cmd.Neotree, { desc = 'Neotree toggle' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'python', 'nix', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
